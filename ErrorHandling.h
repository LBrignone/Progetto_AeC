...
typedef enum {ERR_open_file, ERR_empty_field, ERR_file_format, ERR_hour_set, ERR_string_identifier, ERR_academic_year, ERR_date_field_conversion,
              ...
              ERR_id_field, ERR_missing_professor, ERR_date_overlap, ERR_professor_changed, ERR_update_database,
              OK = std::numeric_limits<unsigned int>::max()} t_typeErrorDefinitionReadingFile;
