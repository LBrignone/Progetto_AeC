...
typedef enum {ERR_arguments_number, ERR_file_name, ERR_open_file, ERR_empty_file, ERR_empty_field, ERR_file_format, ERR_student_format, ERR_professor_format, ERR_classroom_format, ERR_hour_set, ERR_string_identifier, ERR_academic_year, ERR_date_field_conversion,
